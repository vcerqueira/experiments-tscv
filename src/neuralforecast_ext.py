    ...
    def _no_refit_cross_validation(
        ...
        try:
            ...
            if df is not None:
                ...
                # Reset any stale vocabulary and build it from the training portion only.
            ...
            for model in self.models:
                ...
                if use_fitted:
                    ...
                    # Custom: fit on train_dataset (subset of uids), predict on full dataset
                    model.fit(
            ...
            if df is None:
                # Reconstruct the target from the stored dataset
